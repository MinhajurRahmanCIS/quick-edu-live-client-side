    ...
    return (
        <nav className="navbar bg-base-200 py-2">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost text-sm md:text-xl">Ai Professor</Link>
...

            {
                user?.uid
                    ...
                    :
                    <div className="navbar-end gap-2">
                        <Link to="/signup" className="btn text-white font-bold btn-neutral btn-sm md:btn-md hover:bg-slate-700">Sign Up</Link>
